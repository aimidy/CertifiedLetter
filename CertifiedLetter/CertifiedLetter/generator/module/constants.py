...
BASE_RENDER_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
LETTER_FORMAT_PATH = os.path.join(BASE_RENDER_DIR, 'module/res/tw_lal.pdf')
DEFAULT_FONT_PATH = os.path.join(BASE_RENDER_DIR, 'module/res/TW-Kai-98_1.ttf')
_PDF_INCH = 72
########################################################################
